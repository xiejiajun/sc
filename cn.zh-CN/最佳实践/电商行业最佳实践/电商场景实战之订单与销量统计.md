...
![销量](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41087/155316173734717_zh-CN.png)
...
-   模块2
 ...
 |
    ...
    1.  操作类型为Insert
        ...
        ![undefined|center](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41087/155316173834718_zh-CN.png)
    ...
    2.  操作类型为Update
        ...
        ![undefined|center](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41087/155316173834719_zh-CN.png)

    3.  操作类型为Delete

        所有Column值为被删除的记录值，即为更新前的值。所以`dts_before_flag＝Y`，`dts_after_flag=N`。

        ![undefined|center](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41087/155316173834721_zh-CN.png)
